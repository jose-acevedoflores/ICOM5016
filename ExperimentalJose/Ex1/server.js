...
app.get('/', function(request, response) {
	...
	//Add the length fot the individual categories in the JSON generate vaer
...
app.get('/home',function(req, res ) {
	...
	pg.connect(conString, function(err, client, done) {
 		if(err) {
  		...
  		console.log("HERE");
  		client.query('SELECT * FROM ONLY sale_product WHERE category_id = $1 ', ['2'], function(err, result) {
